...
const Callapi = () => {
    const jsonUrl = 'https://script.google.com/macros/s/AKfycbymaqqWqREzDik0imzPPx-WgcrNPozjte9497PqcFoiH2flbuTmc8uPy6PtAF_Gamz8/exec';
                            ...
                            <View>
                                <View style={styles.card}>
                                    ...
                                    <View>
                                        ...
                                        <Text style={styles.text}>{item.telepon}</Text>
